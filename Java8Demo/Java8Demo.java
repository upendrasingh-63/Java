...
public class Java8Demo {
    public static void main(String[] args) {
        ...
        // lambda), functional programing(treating function as variable) initially OOP language but now both
        ...
        // modifier),---- it is used to implements functional interface -> those interfaces which have only one abstract method(no body) other default function can be allowed
        ...
        //we are using reference of functional interface MathOperation for holding lambda expression
        ...
        //Function -> it is also functional interface which will work for you give and take output
        ...
        UnaryOperator<Integer> unaryOperator=x->x*2;//it is same as function but take one data type extends function
        ...
        //Method reference --> use without invoking and can use in place of lambda expression, giving method as parameter
...
//        List<MobilePhone> modify= list2.stream().map(x->new MobilePhone(x)).collect(Collectors.toList());
...
//the work of this class is to run the method by implementing runnable but this can be done by lambda alone
